...
import { SESSION_TABS_SUBSCRIBE_METHOD } from './session-tabs-subscribe-method'
...
export const SESSION_TAB_METHODS: RpcAnyMethod[] = [
  ...
  defineMethod({
    ...
    handler: async (params, { runtime, clientKind, signal, pairedDeviceId }) => {
      const baseOpts = {
